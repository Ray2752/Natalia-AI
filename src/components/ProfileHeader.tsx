...
const ProfileHeader = ({user}: {user: UserResource |null|undefined }) => {
  ...
  return (
    <div className='mb-10 relative backdrop-blur-sm border border-border p-6'>
        ...
        <div className='flex flex-col md:flex-row items-star md:items-center gap-6'>
        <div className='relative'>
            ...
            <div className='w-24 h-24 rounded-lg bg-gradiant-to-br from-primary/30 to-secondary/30 flex items-center justify-center'>
